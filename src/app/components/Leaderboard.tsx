...
const Leaderboard: React.FC<LeaderboardProps> = ({ leaderboard, globalWalletAddress }) => {
  ...
  return (
    <>
      {/* Desktop Leaderboard */}
      <div className="hidden lg:block w-80 bg-gradient-to-b from-pink-200/70 to-purple-2  00/70 backdrop-blur-sm border-r border-pink-300/50 p-4 overflow-y-auto max-h-[calc(100vh-8rem)] purple-scrollbar">
      ...
      <style jsx global>{`
        ...
        .purple-scrollbar::-webkit-scrollbar-thumb {
          background: linear-gradient(45deg, #9966CC, #fa52b6, #9966CC);
          border-radius: 8px;
          box-shadow: 
        ...
        .purple-scrollbar::-webkit-scrollbar-thumb:hover {
          background: linear-gradient(45deg, #9966CC, #ff29a8, #9966CC);
          box-shadow: 
